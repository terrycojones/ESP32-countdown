# Vendored from micropython-lib (python-ecosys/requests), unmodified.
# Source: https://raw.githubusercontent.com/micropython/micropython-lib/master/python-ecosys/requests/requests/__init__.py
#
# Note: HTTPS connections do not verify the server certificate
# (tls.CERT_NONE below) -- this is the library's own default. Acceptable
# for this project's threat model (see DESIGN.md), but worth knowing if
# reused elsewhere.
import socket
